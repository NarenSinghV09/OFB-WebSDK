(function ($) {
    ...
    KorePickers.prototype.addDateRangeListener = function (mainConfig) {
        ...
        daterangeInput.bind('datepicker-first-date-selected', function (event, obj) {
            ...
            _korePickers.find('.kore-action-sheet .dateRangePickerContainer .showEnddate .showEndYear').css({
                "opacity": "0"
            });
        })
    ...
    KorePickers.prototype.addClickEventRangeCalender = function (mainConfig) {
        ...
        _korePickers.find(".kore-action-sheet .dateRangePickerContainer .date-picker-wrapper").css({
            "border": "0px",
            "background-color": "white"
        });
        _korePickers.find(".kore-action-sheet .dateRangePickerContainer .month-wrapper").css({
            "border": "0px"
        });
    ...
    KorePickers.prototype.addDateListener = function (mainConfig) {
        ...
        var startdateValue;
        var language = mainConfig[1].dateConfig.lang ? mainConfig[1].dateConfig.lang : "en";
        // var enddateValue;
        // var showStartDateValue=null;
        // var showEndDateValue=null;
        // var showStartYearValue=null;
        ...
        _korePickers.find(".kore-action-sheet .datePickerContainer .confirmBTN").click(function () {
            ...
            if (language && language === "es") {
                var spanishDate = moment(startdateValue).locale('es').format('D [de] MMMM [de] YYYY') || moment().locale('es').format('D [de] MMMM [de] YYYY');
                startViewDate = replaceMonthWithSpanish(spanishDate);
            } else {
                startViewDate = moment(startdateValue).format('MMMM Do, YYYY') || moment();
            }
    ...
    KorePickers.prototype.addClickEventCalender = function (mainConfig) {
        ...
        if (mainConfig[1].dateConfig.showdueDate) {
            $(".kore-chat-window .kore-action-sheet").css({
                "height": "485px"
            });
        ...
        if (mainConfig[1].dateConfig.startDate) {
            ...
            $(".day.toMonth.invalid.real-today").css({
        ...
        _korePickers.find(".kore-action-sheet  .datePickerContainer .date-picker-wrapper").css({
            "border": "0px",
            "background-color": "white"
        });
        _korePickers.find(".kore-action-sheet  .datePickerContainer .month-wrapper").css({
            "border": "0px"
        });
    ...
    function hlght(config) {
        ...
        $(".month-wrapper .day.toMonth.valid").last().css({
            "background-color": "#e94848"
        });
        $(".month-wrapper .day.toMonth.valid.tmp").last().css({
            "background-color": "#e94848"
        });
        //}
    }

    function replaceMonthWithSpanish(dateString) {
        var englishToSpanishMonths = {
            'January': 'enero',
            'February': 'febrero',
            'March': 'marzo',
            'April': 'abril',
        ...
        // Replace only the English month using a regex with a callback
        return dateString.replace(/\b(January|February|March|April|May|June|July|August|September|October|November|December)\b/, function (match) {
            return englishToSpanishMonths[match];
        });
    }
    ...
    KorePickers.prototype.addClickEventClock = function (mainConfig) {
        ...
        setTimeout(function () {
            _korePickers.find(".kore-action-sheet").animate({
                height: 'toggle'
            });
        ...
        setTimeout(function () {
            _korePickers.find(".kore-action-sheet .clockPickerContainer .clockpicker-popover").css({
                "display": "block",
                "top": "75px ",
                "left": "80.5px",
            });
            _korePickers.find(".kore-action-sheet .clockPickerContainer .clockpicker-popover .clockpicker-plate").css({
                "margin-left": "25px"
            });
            _korePickers.find(".btn.btn-sm.btn-default.clockpicker-button.pm-button").css({
                "opacity": "0.4"
            });
        }, 0);
    }
    KorePickers.prototype.addClockListener = function (mainConfig) {
        ...
        _korePickers.find(".btn.btn-sm.btn-default.clockpicker-button.am-button").click(function () {
            ...
            _korePickers.find(".btn.btn-sm.btn-default.clockpicker-button.am-button").css({
                "opacity": "1"
            });
        })
